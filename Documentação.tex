...
\begin{document}
	...
	\section{Introdução}
	Numa forma de simplificar a elaboração de espectros de RMN (ressonância magnética nucelar) no \LaTeX, foi desenvolvido este pacote para tornar o código uma linguagem amigável ao usuário. 
	
	Como espectros de RMN de carbono desacoplados de hidrogênio não apresentam multiplicidades de sinal, a modelagem matemática dos sinais é bem mais simples comparados aos sextetos e multipletos do mais usual RMN de hidrogênio-1, e por isto foi escolhido para este primeiro pacote de uma série de pacotes voltados a elaboração de materiais químicos usando \LaTeX.
	
	O repositório deste pacote pode ser acessado em  \url{https://github.com/danielsramilo/rmnc}.
